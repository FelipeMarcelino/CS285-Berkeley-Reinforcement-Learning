    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths):
        ...
        if self.log_video and train_video_paths != None:
            ...
            self.logger.log_paths_as_videos(
                train_video_paths, itr, fps=self.fps, max_videos_to_save=MAX_NVIDEO, video_title="train_rollouts"
            )
            self.logger.log_paths_as_videos(
                eval_video_paths, itr, fps=self.fps, max_videos_to_save=MAX_NVIDEO, video_title="eval_rollouts"
            )
